                    ...
                    <ul class="dropdown-menu dropdown-tasks">
                        <li>
                            <a href="#">
                                <div>
                                    <p>
                                        <i class="fa fa-thermometer-full fa-fw"></i><strong> Temperature</strong>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <p>
                                        <i class="fa fa-heartbeat fa-fw"></i><strong> Heart Rate</strong>
                        ...
                        <li>
                            <a href="#">
                                <div>
                                    <p>
                                        <i class="fa fa-envelope fa-fw"></i><strong> Respiration</strong>
                                        <span class="pull-right text-muted">10 minutes ago</span>
                                    </p>
                                </div>
                            </a>
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="linegraph.php">Line Charts</a>
                                </li>
                                <li>
                                    <a href="bargraph.php">Bar Charts</a>
                                </li>
                            </ul>
                        </li>
                        <li>
